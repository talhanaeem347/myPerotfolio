          ...
          <SplideSlide key={index} className=' h-screen'>
            <div className="w-full h-full">
              <div className="flex relative h-full">
                <img alt="gallery" className="absolute inset-0 w-full h-full object-cover object-center " src={bg.url} />
                <div className="relative z-10 h-full w-full flex items-center justify-center  flex-col text-gray-200 text-opacity-90 ">
                  <h2 className="tracking-widest text-6xl title-font font-medium mb-3">{bg.title}</h2>
                  <h1 className="title-font text-3xl font-mediu mb-3 text-center px-4">{bg.subTitle}</h1>
                  <p className="leading-relaxed text-xl px-4 text-center">{bg.text}</p>
                </div>
              </div>
            </div>
          </SplideSlide>
