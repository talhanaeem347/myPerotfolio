...
export default () => {
  return (
    <section className="w-screen h-screen   bg-blue-100 flex justify-center p-4 items-center lg:p-10 md:p-10">
      <div className="h-full w-full bg-red-100 rounded ">
        <h1 className="text-3xl font-bold text-center h-1/6   flex items-center justify-center " >Work</h1>
